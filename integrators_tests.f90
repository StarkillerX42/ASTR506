program test
    ...
    call euler_forward(n, masses, positions, velocities, dt, poses, vels)
    print *, "Euler forward:"
    do i=1, n
        print *, poses(i, :)
    end do
    ...
    call kdk(n, masses, positions, velocities, dt, poses, vels)
    print *, "Kick Drift Kick:"
    print *, poses
    print *, vels
    print *, ""

    call rk_pde(n, masses, positions, velocities, poses, vels)
    print *, "Runge Kutta PDE"
    print *, poses
    print *, vels
    print *, ""

    call rk3_classic(n, masses, positions, velocities, dt, poses, vels)
    print *, "Runge Kutta Classic 3:"
    print *, poses
    print *, vels

    call rkf45(n, masses, positions, velocities, dt, poses_low, vels_low, &
    ...
    call kdk_gal(n, masses, gal_positions, gal_velocities, dt, poses, vels)
